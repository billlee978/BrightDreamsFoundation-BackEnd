...
public class MissionHistoryController {
    ...
    public HttpResponseEntity searchMissionHistory(@PathVariable("id") Long id, String keywords) {
        List<MissionHistory> histories = missionHistoryService.searchHistory(id, keywords);
        return new HttpResponseEntity(200, histories, "查询成功！");
    }
